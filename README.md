...
```
npm install --save-dev fakeaws
```

## Usage

[https://github.com/k-kinzal/fakemock/blob/master/test/index.spec.js](https://github.com/k-kinzal/fakemock/blob/master/test/index.spec.js)
